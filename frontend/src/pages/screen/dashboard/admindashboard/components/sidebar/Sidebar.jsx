...
>
  <ul className="nav nav-pills flex-column mb-auto">
    <li className="nav-item mt-2">
      <a href="/admindashboard" className="nav-link fw-bold text-black fs-6" aria-current="page">
  ...
  <path d="m8 3.293 6 6V13.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5V9.293l6-6Z"/>
    ...
    <li>
      <a href="/user" className="nav-link fw-medium text-black">
        <svg className="bi pe-none me-2" width={0} height={16}>
          <use xlinkHref="#people-circle" />
        </svg>
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock-history me-4" viewBox="0 0 16 16">
